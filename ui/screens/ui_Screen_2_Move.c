...
void ui_Screen_2_Move_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Label_X_Position_Number, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Label_Time_3, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Label_Z_Position_Number, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
