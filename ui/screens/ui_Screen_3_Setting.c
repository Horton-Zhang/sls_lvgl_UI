...
void ui_Screen_3_Setting_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Roller4, &lv_font_montserrat_20, LV_PART_SELECTED | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Roller3, &lv_font_montserrat_20, LV_PART_SELECTED | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Roller2, &lv_font_montserrat_20, LV_PART_SELECTED | LV_STATE_DEFAULT);
